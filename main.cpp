...
public:
    ...
    friend void printDetails(const shopping &item);  // Friend function
    void menu();
    void administrator();
    void buyer();
    void add();
...
{
    cout << "Product Code: " << item.pcode << "\n";
    cout << "Product Name: " << item.pname << "\n";
    cout << "Product Price: " << item.price << "\n";
    cout << "Discount: " << item.dis << "%" << "\n";
}
